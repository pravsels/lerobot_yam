"""i2rt-compatible CAN interface wrapper."""
...
class CanInterface:
    ...
    def _send_message_get_response(
        ...
        """Send a message over the CAN bus and wait for a response."""
    ...
    def _receive_message(
        ...
        raise AssertionError(f"Failed to receive message for motor id {motor_id}")
